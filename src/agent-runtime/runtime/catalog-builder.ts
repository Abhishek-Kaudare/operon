...
function buildPolicies(
	...
	return {
		...
		creation: {
			...
			journalName: settings.inlineTaskJournalName,
			journalHeading: settings.inlineTaskJournalHeading,
			journalAddsStartDate: settings.inlineTaskJournalAddStartDate,
			journalAddsScheduledDate: settings.inlineTaskJournalAddScheduledDate,
			createJournalNotesAsFileTasks: settings.createJournalNotesAsOperonTask,
