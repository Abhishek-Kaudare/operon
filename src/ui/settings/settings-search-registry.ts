...
export const OPERON_SETTINGS_SEARCH_REGISTRY: readonly OperonSettingsSearchEntry[] = [
	...
	e('settings', 'coreGeneral', 'checkForUpdatesOnStartup', 'settings', 'checkForUpdatesOnStartup', 'checkForUpdatesOnStartupDesc', 'toggle', ['version', 'release', 'update check', 'startup check', 'compatible version']),
	...
	e('automation', 'tasksInlineTasks', 'inlineTaskJournalName', 'settings', 'Target Day Journal', 'Select which day journal to target for inline tasks.', 'dropdown', ['journals', 'journal name', 'target journal']),
	e('automation', 'tasksInlineTasks', 'inlineTaskJournalHeading', 'settings', 'Journal Heading', 'Heading under which journal inline tasks are inserted.', 'text', ['journals', 'journal heading', 'heading', 'keyword']),
	e('automation', 'tasksInlineTasks', 'inlineTaskJournalAddStartDate', 'settings', 'Auto-fill start date from journal note date', 'Auto-fill start date from the date of the journal note when created blank.', 'toggle', ['journals', 'journal defaults', 'start date', 'dateStarted', 'inline task']),
	e('automation', 'tasksInlineTasks', 'inlineTaskJournalAddScheduledDate', 'settings', 'Auto-fill scheduled date from journal note date', 'Auto-fill scheduled date from the date of the journal note when created blank.', 'toggle', ['journals', 'journal defaults', 'scheduled date', 'dateScheduled', 'inline task']),
	...
	e('automation', 'tasksFileTasks', 'createJournalNotesAsOperonTask', 'settings', 'Initialize new journal notes as Operon file tasks', 'When creating a new journal note via Operon, initialize it with a minimal Operon ID.', 'toggle', ['journals', 'file task', 'new task', 'initialize journal']),
	...
	e('views', 'viewsCalendar', 'calendarShowHoverAddButton', 'calendar', 'showHoverAddButton', 'showHoverAddButtonDesc', 'toggle', ['calendar', 'quick add', 'hover add', 'add button', 'plus button']),
	...
	e('views', 'viewsKanban', 'kanbanShowHoverAddButton', 'settings', 'kanbanShowHoverAddButton', 'kanbanShowHoverAddButtonDesc', 'toggle', ['kanban', 'quick add', 'hover add', 'add button', 'plus button']),
	e('views', 'viewsKanban', 'kanbanTaskShowNotesPreview', 'settings', 'kanbanTaskShowNotesPreview', 'kanbanTaskShowNotesPreviewDesc', 'toggle', ['kanban', 'kanban card notes', 'kanban note preview', 'notes preview', 'card notes', 'not önizleme']),
	e('views', 'viewsKanban', 'kanbanTaskShowSubtaskProgress', 'settings', 'kanbanTaskShowSubtaskProgress', 'kanbanTaskShowSubtaskProgressDesc', 'toggle', ['kanban', 'kanban card progress', 'subtask progress', 'subtasks progress', 'body progress', 'task title progress', 'between title and chips']),
	e('views', 'viewsKanban', 'kanbanTaskShowPlainCheckboxProgress', 'settings', 'kanbanTaskShowPlainCheckboxProgress', 'kanbanTaskShowPlainCheckboxProgressDesc', 'toggle', ['kanban', 'kanban card progress', 'checkbox progress', 'plain checkbox progress', 'footer progress']),
	section('views', 'viewsKanban', 'kanbanPresets', 'settings', 'kanbanPresets', 'kanbanPresetsDesc', ['kanban', 'board', 'kanban presets', 'kanban preset controls', 'preset controls', 'favorite presets', 'starred presets', 'favorites', 'swimlane', 'column']),
	section('views', 'viewsFilters', 'filters', 'filterSets', 'userFiltersTitle', 'userFiltersDesc', ['filters', 'user filters', 'saved filters', 'filter view', 'embedded filters', 'favorite presets', 'starred presets', 'favorites', 'conditions', 'match logic', 'sorting']),
	e('views', 'viewsTables', 'tableDefaultPresetId', 'settings', 'tableDefaultPreset', 'tableDefaultPresetDesc', 'dropdown', ['table', 'operon table', 'table default preset', 'table preset', 'database', 'reporting']),
	e('views', 'viewsTables', 'tableEmbedVisibleRows', 'settings', 'tableEmbedVisibleRows', 'tableEmbedVisibleRowsDesc', 'dropdown', ['table', 'operon table', 'embedded table', 'embed rows', 'visible rows', 'table height']),
	e('views', 'viewsTables', 'tableShowLineNumbers', 'settings', 'tableShowLineNumbers', 'tableShowLineNumbersDesc', 'toggle', ['table', 'operon table', 'line numbers', 'row numbers', 'admin columns', 'administrative columns']),
	e('views', 'viewsTables', 'tableShowTaskIcon', 'settings', 'tableShowTaskIcon', 'tableShowTaskIconDesc', 'toggle', ['table', 'operon table', 'task icon', 'status icon', 'admin columns', 'administrative columns', 'context menu']),
	e('views', 'viewsTables', 'tableShowTaskTypeIcon', 'settings', 'tableShowTaskTypeIcon', 'tableShowTaskTypeIconDesc', 'toggle', ['table', 'operon table', 'task type', 'inline task', 'file task', 'type icon', 'admin columns', 'administrative columns']),
	section('views', 'viewsTables', 'tablePresets', 'settings', 'tablePresets', 'tablePresetsDesc', ['table', 'operon table', 'table presets', 'table preset controls', 'preset controls', 'favorite presets', 'starred presets', 'favorites', 'columns', 'summaries', 'reporting']),
	...
	e('views', 'viewsFilters', 'filterSubtaskAutoExpandLimit', 'settings', 'filterSubtaskAutoExpandLimit', 'filterSubtaskAutoExpandLimitDesc', 'dropdown', ['filter', 'filter view', 'subtasks', 'auto expand subtasks', 'expanded subtasks']),
	...
	e('ui', 'interfaceTaskChips', 'inlineTaskShowNoteAction', 'settings', 'inlineTaskNoteAction', 'inlineTaskIconsSectionDesc', 'toggle', ['task chips', 'inline task actions', 'note action', 'not']),
		...
		e('ui', 'interfaceTaskChips', 'kanbanTaskShowNoteAction', 'settings', 'inlineTaskNoteAction', 'kanbanTaskNoteActionDesc', 'toggle', ['task chips', 'kanban task actions', 'kanban card actions', 'note action', 'not']),
		e('ui', 'interfaceTaskChips', 'kanbanTaskShowSubtaskAction', 'settings', 'inlineTaskSubtaskAction', 'kanbanTaskSubtaskActionDesc', 'toggle', ['task chips', 'kanban task actions', 'kanban card actions', 'subtask action', 'alt görev']),
		e('ui', 'interfaceTaskChips', 'kanbanTaskShowPlainCheckboxAction', 'settings', 'kanbanTaskOpenCheckboxAction', 'kanbanTaskOpenCheckboxActionDesc', 'toggle', ['task chips', 'kanban task actions', 'kanban card actions', 'plain checkbox', 'normal checkbox', 'onay kutusu']),
	...
	section('ui', 'interfaceTaskChips', 'taskWikilinkOverlayChips', 'settings', 'taskWikilinkOverlayIconsSection', 'taskWikilinkOverlayIconsSectionDesc', ['task chips', 'task wikilink overlay chips', 'task wikilink overlay icons', 'task wikilink overlay', 'file task overlay chips', 'file task overlay icons', 'overlay chips']),
	...
	e('ui', 'interfaceStateIcons', 'taskStatusIconColorSource', 'settings', 'taskStatusIconColorSource', 'taskStatusIconColorSourceDesc', 'dropdown', ['state icons', 'state icons and colors', 'task icon color', 'state icon color', 'status icon color', 'no color']),
