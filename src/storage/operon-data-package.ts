	...
	return {
		...
		ui: {
			...
			taskCreationProfile: {
				...
				createJournalNotesAsOperonTask: normalized.createJournalNotesAsOperonTask,
				inlineTaskJournalName: normalized.inlineTaskJournalName,
				inlineTaskJournalAddStartDate: normalized.inlineTaskJournalAddStartDate,
				inlineTaskJournalAddScheduledDate: normalized.inlineTaskJournalAddScheduledDate,
				inlineTaskJournalHeading: normalized.inlineTaskJournalHeading,
